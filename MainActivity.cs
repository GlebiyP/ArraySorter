...
namespace Phoneword
{
    ...
    public class MainActivity : AppCompatActivity
    {
            ...
            sortButton.Click += (sender, e) =>
            {
                ...
                else
                {
                    ...
                    if (!string.IsNullOrWhiteSpace(bubbleSortedArray))
                    {
                        ...
                        if (Sorts.BubbleSort.Counter != 0)
                        {
                            bubbleSortedText.Text += "\nIterations: " + Sorts.BubbleSort.Counter.ToString();
                    ...
                    if (!string.IsNullOrWhiteSpace(cocktailSortedArray))
                    {
                        ...
                        if (Sorts.CocktailSort.Counter != 0)
                        {
                            cocktailSortedText.Text += "\nIterations: " + Sorts.CocktailSort.Counter.ToString();
                            cocktailSortedText.Text += "\nTime: " + stopwatch.ElapsedMilliseconds.ToString() + " ms.\n";
                        }
                    }
                    ...
                    if (!string.IsNullOrWhiteSpace(insertionSortedArray))
                    {
                        ...
                        if (Sorts.InsertionSort.Counter != 0)
                        {
                            insertionSortedText.Text += "\nIterations: " + Sorts.InsertionSort.Counter.ToString();
                            insertionSortedText.Text += "\nTime: " + stopwatch.ElapsedMilliseconds.ToString() + " ms.\n";
                        }
                    }
                    ...
                    stopwatch.Restart();
                    nums = Sorts.MergeSort.Sort(nums);
                    stopwatch.Stop();
                    ...
                    if (!string.IsNullOrWhiteSpace(mergeSortedArray))
                    {
                        ...
                        if (Sorts.MergeSort.Counter != 0)
                        {
                            mergeSortedText.Text += "\nIterations: " + Sorts.MergeSort.Counter.ToString();
                            mergeSortedText.Text += "\nTime: " + stopwatch.ElapsedMilliseconds.ToString() + " ms.\n";
                        }
                    }
                    ...
                    if (!string.IsNullOrWhiteSpace(quickSortedArray))
                    {
                        ...
                        if (Sorts.QuickSort.Counter != 0)
                        {
                            quickSortedText.Text += "\nIterations: " + Sorts.QuickSort.Counter.ToString();
                            quickSortedText.Text += "\nTime: " + stopwatch.ElapsedMilliseconds.ToString() + " ms.\n";
                        }
                    }
        ...
        /*FilePickerFileType customFileType =
            ...
            {
                { DevicePlatform.Android, new[] {"application/txt"} },
            });*/
